...
def menu() -> None:
    ...
    while True:
        try:
            tupla_numeros = input("Ingrese la cantidad de viajes realizados y el valor del pasaje (12, 444): ")
